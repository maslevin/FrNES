...
void setup_gui_options_screen() {
	...
	helpstyle.Selected_Text_Color = options.GUI_TextColor;
...
void Generate_GUI_Options_List() {
	...
	snprintf(Red_OWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_OutsideWindowColor >> 16) & 0xFF));
	GUI_Options[2] = Red_OWC_Buffer;
	GUI_Options[3] = Options_GreenComp;
	snprintf(Green_OWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_OutsideWindowColor >> 8) & 0xFF));
	GUI_Options[4] = Green_OWC_Buffer;
	GUI_Options[5] = Options_BlueComp;
	snprintf(Blue_OWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, (options.GUI_OutsideWindowColor & 0xFF));
	GUI_Options[6] = Blue_OWC_Buffer;

	GUI_Options[7] = " ";
	GUI_Options[8] = Options_InsideWindowColor;
	GUI_Options[9] = Options_RedComp;
	snprintf(Red_IWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_InsideWindowColor >> 16) & 0xFF));
	GUI_Options[10] = Red_IWC_Buffer;
	GUI_Options[11] = Options_GreenComp;
	snprintf(Green_IWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_InsideWindowColor >> 8) & 0xFF));
	GUI_Options[12] = Green_IWC_Buffer;
	GUI_Options[13] = Options_BlueComp;
	snprintf(Blue_IWC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, (options.GUI_InsideWindowColor & 0xFF));	
	GUI_Options[14] = Blue_IWC_Buffer;

	GUI_Options[15] = " ";
	GUI_Options[16] = Options_TextColor;
	GUI_Options[17] = Options_RedComp;
	snprintf(Red_TC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_TextColor >> 16) & 0xFF));
	GUI_Options[18] = Red_TC_Buffer;
	GUI_Options[19] = Options_GreenComp;
	snprintf(Green_TC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_TextColor >> 8) & 0xFF));
	GUI_Options[20] = Green_TC_Buffer;
	GUI_Options[21] = Options_BlueComp;
	snprintf(Blue_TC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, (options.GUI_TextColor & 0xFF));
	GUI_Options[22] = Blue_TC_Buffer;

	GUI_Options[23] = " ";
	GUI_Options[24] = Options_SelectedTextColor;
	GUI_Options[25] = Options_RedComp;
	snprintf(Red_STC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_SelectedTextColor >> 16) & 0xFF));
	GUI_Options[26] = Red_STC_Buffer;
	GUI_Options[27] = Options_GreenComp;
	snprintf(Green_STC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_SelectedTextColor >> 8) & 0xFF));
	GUI_Options[28] = Green_STC_Buffer;
	GUI_Options[29] = Options_BlueComp;
	snprintf(Blue_STC_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, (options.GUI_SelectedTextColor & 0xFF));
	GUI_Options[30] = Blue_STC_Buffer;

	GUI_Options[31] = " ";
	GUI_Options[32] = Options_BGColor;
	GUI_Options[33] = Options_RedComp;
	snprintf(Red_BG_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_BGColor >> 16) & 0xFF));
	GUI_Options[34] = Red_BG_Buffer;
	GUI_Options[35] = Options_GreenComp;
	snprintf(Green_BG_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, ((options.GUI_BGColor >> 8) & 0xFF));
	GUI_Options[36] = Green_BG_Buffer;
	GUI_Options[37] = Options_BlueComp;
	snprintf(Blue_BG_Buffer, SLIDER_STRING_BUFFER_LENGTH, "<Slider> <SBC_MAX = %u> <SBC_MIN = %u> <SBC_VALUE = %lu>", 255, 0, (options.GUI_BGColor & 0xFF));
...
void Handle_GUI_Interface(cont_state_t* my_state) {
	...
	if ((my_state -> buttons & CONT_DPAD_LEFT) && 
		...
		switch(mydata.Highlighted_Index) {
			case 2:
				temp = ((options.GUI_OutsideWindowColor >> 16) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_OutsideWindowColor = (options.GUI_OutsideWindowColor & 0x0000FFFF) | (temp << 16);
				...
				break;
			case 4:
				temp = ((options.GUI_OutsideWindowColor >> 8) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_OutsideWindowColor = (options.GUI_OutsideWindowColor & 0x00FF00FF) | (temp << 8);
					Generate_GUI_Options_List();
					mystyle.Border_Color = options.GUI_OutsideWindowColor;
					helpstyle.Border_Color = options.GUI_OutsideWindowColor;
				}
				break;
			case 6:
				temp = (options.GUI_OutsideWindowColor & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_OutsideWindowColor = (options.GUI_OutsideWindowColor & 0x00FFFF00) | (temp);
					Generate_GUI_Options_List();
					mystyle.Border_Color = options.GUI_OutsideWindowColor;
					helpstyle.Border_Color = options.GUI_OutsideWindowColor;
				}
				break;
			case 10:
				temp = ((options.GUI_InsideWindowColor >> 16) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_InsideWindowColor = (options.GUI_InsideWindowColor & 0x0000FFFF) | (temp << 16);
					Generate_GUI_Options_List();
				...
				break;
			case 12:
				temp = ((options.GUI_InsideWindowColor >> 8) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_InsideWindowColor = (options.GUI_InsideWindowColor & 0x00FF00FF) | (temp << 8);
					Generate_GUI_Options_List();
					mystyle.Inside_Color = options.GUI_InsideWindowColor;
					helpstyle.Inside_Color = options.GUI_InsideWindowColor;
				}
				break;
			case 14:
				temp = (options.GUI_InsideWindowColor & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_InsideWindowColor = (options.GUI_InsideWindowColor & 0x00FFFF00) | (temp);
					Generate_GUI_Options_List();
					mystyle.Inside_Color = options.GUI_InsideWindowColor;
					helpstyle.Inside_Color = options.GUI_InsideWindowColor;
				}
			...
			case 18:
				temp = ((options.GUI_TextColor >> 16) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_TextColor = (options.GUI_TextColor & 0xFF00FFFF) | (temp << 16);
					Generate_GUI_Options_List();
					mystyle.Text_Color = options.GUI_TextColor;
					helpstyle.Text_Color = options.GUI_TextColor;
					mystyle.Header_Text_Color = options.GUI_TextColor; //0x8000;
					helpstyle.Header_Text_Color = options.GUI_TextColor; //0x8000;
				}
				break;
			case 20:
				temp = ((options.GUI_TextColor >> 8) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_TextColor = (options.GUI_TextColor & 0xFFFF00FF) | (temp << 8);
					Generate_GUI_Options_List();
					mystyle.Text_Color = options.GUI_TextColor;
					helpstyle.Text_Color = options.GUI_TextColor;
					mystyle.Header_Text_Color = options.GUI_TextColor; //0x8000;
				...
				break;
			case 22:
				temp = (options.GUI_TextColor & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_TextColor = (options.GUI_TextColor & 0xFFFFFF00) | (temp);
					Generate_GUI_Options_List();
					mystyle.Text_Color = options.GUI_TextColor;
					helpstyle.Text_Color = options.GUI_TextColor;
					mystyle.Header_Text_Color = options.GUI_TextColor; //0x8000;
			...
			case 26:
				temp = ((options.GUI_SelectedTextColor >> 16) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_SelectedTextColor = (options.GUI_SelectedTextColor & 0xFF00FFFF) | (temp << 16);
					Generate_GUI_Options_List();
					mystyle.Selected_Text_Color = options.GUI_SelectedTextColor;
				...
				break;
			case 28:
				temp = ((options.GUI_SelectedTextColor >> 8) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_SelectedTextColor = (options.GUI_SelectedTextColor & 0xFFFF00FF) | (temp << 8);
					Generate_GUI_Options_List();
					mystyle.Selected_Text_Color = options.GUI_SelectedTextColor;
					helpstyle.Selected_Text_Color = options.GUI_SelectedTextColor;
				}
				break;
			case 30:
				temp = (options.GUI_SelectedTextColor & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_SelectedTextColor = (options.GUI_SelectedTextColor & 0xFFFFFF00) | (temp);
					Generate_GUI_Options_List();
					mystyle.Selected_Text_Color = options.GUI_SelectedTextColor;
					helpstyle.Selected_Text_Color = options.GUI_SelectedTextColor;
				}
			...
			case 34:
				temp = ((options.GUI_BGColor >> 16) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_BGColor = (options.GUI_BGColor & 0x0000FFFF) | (temp << 16);
					Generate_GUI_Options_List();
				}
				break;
			case 36:
				temp = ((options.GUI_BGColor >> 8) & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_BGColor = (options.GUI_BGColor & 0x00FF00FF) | (temp << 8);
					Generate_GUI_Options_List();
				}
				break;
			case 38:
				temp = (options.GUI_BGColor & 0xFF);
				if (temp > 0) {
					temp--;
					options.GUI_BGColor = (options.GUI_BGColor & 0x00FFFF00) | (temp);
					Generate_GUI_Options_List();
				}
				break;
		}
