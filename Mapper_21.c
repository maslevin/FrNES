...
void Mapper_21_Write(uint16 addr, uint8 data) {
    switch (addr & 0xF0CF) {
        ...
        case 0xB000: {
            ...
            PPUBANK[0] = &VROM[Mapper_21_regs[0] * 0x400];
        } break;
        ...
        case 0xB080: {
            ...
            PPUBANK[1] = &VROM[Mapper_21_regs[1] * 0x400];
        } break;
        ...
        case 0xC000: {
            ...
            PPUBANK[2] = &VROM[Mapper_21_regs[2] * 0x400];
        } break;
        ...
        case 0xC080: {
            ...
            PPUBANK[3] = &VROM[Mapper_21_regs[3] * 0x400];
        } break;
        ...
        case 0xD000: {
            ...
            PPUBANK[4] = &VROM[Mapper_21_regs[4] * 0x400];
        } break;
        ...
        case 0xD080: {
            ...
            PPUBANK[5] = &VROM[Mapper_21_regs[5] * 0x400];
        } break;
        ...
        case 0xE000: {
            ...
            PPUBANK[6] = &VROM[Mapper_21_regs[6] * 0x400];
        } break;
        ...
        case 0xE080: {
            ...
            PPUBANK[7] = &VROM[Mapper_21_regs[7] * 0x400];
        } break;
