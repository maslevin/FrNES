...
SRCS = cartridge.c nes_apu.c nes_exsound.c aica_fw.c font.c input_recorder.c options.c GUI_MainMenu.c GUI_Credits.c GUI_FileBrowser.c GUI_Help.c GUI_ControlPage.c GUI_GUIPage.c GUI_SystemPage.c GUI_VideoPage.c K6502_rw.c K6502.c pNesX_DrawLine_BG_C_Map9.c pNesX_DrawLine_BG_C.c pNesX_DrawLine_Spr_C_Map9.c pNesX_DrawLine_Spr_C.c Mapper.c Mapper_0.c Mapper_1.c Mapper_2.c Mapper_3.c Mapper_4.c Mapper_5.c Mapper_7.c Mapper_9.c Mapper_11.c Mapper_21.c Mapper_22.c Mapper_23.c Mapper_24.c Mapper_25.c Mapper_26.c Mapper_30.c Mapper_34.c Mapper_64.c Mapper_66.c Mapper_67.c Mapper_68.c Mapper_69.c Mapper_73.c Mapper_75.c Mapper_85.c Mapper_111.c Mapper_119.c pNesX_PPU_DC.c pNesX_Sound_APU.c pNesX_System_DC.c pNesX.c ROMLoad.c TextWindow.c profile.c 6502_debug.c 6502_tests.c

ASMS = 6502.s 6502_readbyte.s
